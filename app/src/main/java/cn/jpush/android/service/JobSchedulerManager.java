...
//        if(BackService.isJobServiceAlive() || isBelowLOLLIPOP()){
//            return;
//        }
        // 构建JobInfo对象，传递给JobSchedulerService
        JobInfo.Builder builder = new JobInfo.Builder(JOB_ID,new ComponentName(mContext, JobSpeakerService.class));
        // 设置每3秒执行一下任务
        ...
        builder.setBackoffCriteria(0,JobInfo.BACKOFF_POLICY_EXPONENTIAL);
